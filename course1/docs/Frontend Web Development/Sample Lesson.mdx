...
Sample change. Welcome to the lesson on Front-end web development. This would be a **self-paced class** which focuses on one of the fundamental topics in HTML - Text Fundamentals. Please make sure that you are completing the entire lesson.
